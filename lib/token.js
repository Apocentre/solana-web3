...
export const closeTokenAccountIx = async (
  _,
  tokenAccount,
  destination,
  closeAuthority,
  programId = spl.TOKEN_PROGRAM_ID
) => await spl.createCloseAccountInstruction(
  tokenAccount,
  destination,
  closeAuthority,
  null,
...
export const getAssociatedTokenAddress = async (_, token, owner, allowOwnerOffCurve=true, tokenProgram=spl.TOKEN_PROGRAM_ID) => {
  return await spl.getAssociatedTokenAddress(token, owner, allowOwnerOffCurve, tokenProgram)
}

...
export const BN = (_, amount) => new anchor.default.BN(amount)
...
export const getComputationBudgetIx = (_, units) => {
  return ComputeBudgetProgram.setComputeUnitLimit({
    units,
  })
}

export const setComputeUnitPrice = (_, microLamports) => {
...
export const taExists = ta => ta.value.length > 0

export const createATAIxIfNeeded = async (self, user, mint, allowOwnerOffCurve, tokenProgram) => {
  let ix
